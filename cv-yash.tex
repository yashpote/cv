...
\begin{document}
	...
	\item Verification of Probabilistic Systems.
    ...
    \begin{tablist}
		...
		\item[\the\year] \tab  Yash Pote  and Kuldeep S. Meel, \enquote{Testing Probabilistic Circuits}, Target: \textit{NeurIPS},  2021.

		\item[\the\year] \tab  Yash Pote  and Kuldeep S. Meel, \enquote{Tractable and Sample Efficient Testing}, Target: \textit{AISTATS},  2021.
